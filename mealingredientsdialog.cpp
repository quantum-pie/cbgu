...
MealIngredientsDialog::MealIngredientsDialog(ProductDictionary & product_dict, std::shared_ptr<const Meal> meal, QWidget * parent) :
    QDialog{ parent },
    ...
    product_dict_ref{ product_dict }
{
    ...
    auto add_ingredient_action = new QAction(QIcon(":/icons/icons/add.png"), tr("Add Ingredient"), table_context_menu);
    auto remove_ingredient_action = new QAction(QIcon(":/icons/icons/garbage.png"), tr("Remove Ingredient"), table_context_menu);
